...
const root=path.resolve('../../outputs/ControllerCompanion-Prototype-v05.5'),env={...process.env};delete env.ELECTRON_RUN_AS_NODE;
...
try{
 ...
 console.log('PASS packaged v5.5 hidden launch, SDL3 initialization, startup IPC, local UI, runtime files match working source.');
